    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        {bgLetters.map((letter, index) => (
          <motion.div
            ...
            transition={{ duration: 6 + index, repeat: Infinity, ease: "easeInOut", delay: letter.delay }}
          >
            {letter.text}
          </motion.div>
        ))}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-6 items-center relative z-10 mt-12 sm:mt-16 lg:mt-6">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center text-center lg:text-left order-2 lg:order-1 lg:-mt-10">
          ...
          >
            <motion.button
              whileHover={{ scale: 1.02, boxShadow: '0 6px 25px rgba(245,158,11,0.2)' }}
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 font-semibold px-7 py-3.5 rounded-full text-[11px] uppercase tracking-wider transition-all flex items-center justify-center gap-2"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto bg-transparent text-emerald-400/90 border border-emerald-500/20 font-medium px-7 py-3.5 rounded-full text-[11px] uppercase tracking-wider transition-all"
            >
              Browse Curriculums
            </motion.button>
          </motion.div>
        ...
        <div className="lg:col-span-6 relative flex flex-col items-center justify-center min-h-[480px] sm:min-h-[540px] lg:min-h-[600px] order-1 lg:order-2 lg:-mt-12">
          ...
          <motion.div 
            className="relative w-full max-w-[480px] aspect-[1.02] flex items-center justify-center"
